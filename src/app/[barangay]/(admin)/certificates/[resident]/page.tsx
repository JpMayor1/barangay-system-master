  ...
  return (
    <div className="w-full h-full row center gap-x-5">
      <Link
        ...
        href={`/${params.barangay}/certificates/${params.resident}/ID`}
      >
        <Image
          alt="Barangay ID"
          width={290}
      ...
      <Link
        className="w-auto p-5 rounded-xl bg-[#B7E5B4] text-black"
        href={`/${params.barangay}/certificates/${params.resident}/indigency`}
      >
        <Image
          alt="indigency"
          width={190}
      ...
      <Link
        className="w-auto p-5 rounded-xl bg-[#B7E5B4] text-black"
        href={`/${params.barangay}/certificates/${params.resident}/clearance`}
      >
        <Image
          alt="clearance"
          width={190}
      ...
      <Link
        className="w-auto p-5 rounded-xl bg-[#B7E5B4] text-black"
        href={`/${params.barangay}/certificates/${params.resident}/business`}
      >
        <Image
          alt="Business Permit"
          width={190}
